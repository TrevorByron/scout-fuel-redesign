    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="text-muted-foreground px-1.5">
        {row.original.status === "Done" ? (
          <HugeiconsIcon icon={CheckmarkCircle01Icon} strokeWidth={2} className="fill-chart-2" />
        ) : (
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            <DropdownMenuTrigger className="h-6 gap-1 px-2 text-xs/relaxed border-border dark:bg-input/30 hover:bg-input/50 hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground rounded-md border border-solid bg-clip-padding font-medium focus-visible:ring-2 focus-visible:border-ring focus-visible:ring-ring/30 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 outline-none">
