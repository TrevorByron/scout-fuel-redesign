...
export interface TripDetailContentDefaultProps {
  trip: TripPlan
...
export function TripDetailContentDefault({
  trip,
  progress,
  selectedStopIndex,
  onSelectStopIndex,
                ...
                <li key={sp.stopIndex}>
                  ...
                  >
                    ...
                    {comp && comp.savings > 0 ? (
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">At optimized network price</p>
                    ) : null}
                  </button>
                </li>
              )
