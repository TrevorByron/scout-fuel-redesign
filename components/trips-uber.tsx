...
export function TripsUber({ selectedTripId }: TripsUberProps) {
  ...
  return (
    ...
    >
      ...
      <aside
        ref={sidebarRef}
        className="absolute left-0 top-0 bottom-0 z-10 flex w-full min-w-[23.75rem] flex-col overflow-hidden p-4 md:max-w-xl md:w-[43%]"
        aria-label="Trip details"
      >
        <div className="flex min-h-0 flex-1 flex-col justify-end overflow-hidden md:justify-start md:rounded-xl md:border md:border-border md:bg-background/20 md:backdrop-blur-md md:shadow-lg">
          <div className="flex min-h-0 min-w-0 flex-1 flex-col gap-4 overflow-y-auto overflow-x-hidden p-0 md:p-4">
            {selectedTrip ? (
              <div className="flex min-h-0 min-w-0 flex-1 flex-col">
                <div className="shrink-0 p-4 pb-0 md:p-0 md:pb-0">
                  <Button
                    variant="ghost"
                    size="sm"
                ...
                <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden p-4 md:p-0 md:pt-4">
              ...
              <div className="min-h-0 min-w-0 rounded-lg border bg-card/80 text-card-foreground shadow-md ring-1 ring-foreground/10 backdrop-blur-sm overflow-hidden md:rounded-none md:border-0 md:bg-transparent md:shadow-none md:ring-0">
              ...
              <div className="flex min-h-0 min-w-0 flex-1 flex-col gap-4">
                <div>
                  <h2 className="hidden text-xl font-semibold tracking-tight md:block md:text-2xl">Trips</h2>
